...
//category
tj_add_rewrite_rule( "^$portfolio_base/([^/]*)(/page/([0-9]*))?/?$", 'is_portfolio=1&is_entry_category=1&taxonomy=hmp-entry-category&term=$matches[1]&post_type=hmp-entry&paged=$matches[3]', $category_file );

//tag
tj_add_rewrite_rule( "^$portfolio_base/tag/([^/]*)(/page/([0-9]*))?/?$", 'is_portfolio=1&is_entry_tag=1&taxonomy=hmp-entry-tag&term=$matches[1]&post_type=hmp-entry&paged=$matches[3]', $tag_file );
...
//portfolio category
tj_add_rewrite_rule( "^$portfolio_base/([^/]+)(/page/([0-9]*))?/?$", 'post_type=hmp-entry&taxonomy=hmp-entry-category&term=$matches[1]&paged=$matches[3]' );

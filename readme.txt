...
Add a fully functionality integrated Portfolio to your WordPress site. HM Portfolio comes with a set of widgets for visually creating your portfolio layout, or custom page templates can be used if you want that extra level control over your portfolio design.


Report any issues/feature requests here: http://github.com/joehoyle/hmp-Portfolio/issues or you can twitter #jhportfolio for feedback etc.
...
* Added HMP Grid selector widget
...
= 0.9.5 =
Some of your old data will be lost: Main Images, Additional Images and your Portfolio Widgets will need setting up. Not compatible with pre 0.9.5 custom templates. See: http://wiki.github.com/joehoyle/hmp-Portfolio/0901-and-under-upgrade-to-095 for details.
...
* Added option to select Portfolio Menu Order in HM Portfolio settings page
...
* Added Portfolio Tags and HMP Tags Widget
* Also added Manage Tags admin page to HM Portfolio menu.
...
* Added content filters to hmp_portfolio_get_content()
...
* Added HM icon to admin menu page
...
* Added ability to hide certain categories in HM Portfolio Selector widget
* Added template functions: hmp_portfolio_the_date(), hmp_portfoio_category_is_hidden( $cat_obj ), get_extra_taxonomy_tags( return = 'array' )
...
= 0.7.4 =
* Added sorting options to the HM Portfolio Selector Widget
...
3. The HM Portfolio Settings page
...
1. Upload the `hmp-portfolio` folder to the `/wp-content/plugins/` directory
...
You must sign up for a free ShrinkTheWeb account here: http://www.shrinktheweb.com/index.php?view=join , once logged in copy your Access Key ID and Secret Key into the HM Portfolio Settings page.

= The plugin doesn't work, what do I do? =

Visit the Issues page of the plugin homepage at: http://code.google.com/p/hmp-portfolio/issues/list
